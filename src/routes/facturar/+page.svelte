        ...
        await axios.get(`/api/clientes/${casillero}`).then(({ data }) => {
          if (data.cliente) {
            ...
            if (data.cliente.precio !== precioBase) {
              ...
              infoTracking.precio = data.cliente.precio;
            } else {
              especial = false;
    ...
    >
      <div class="card-body">
        ...
        input-primary join-item w-full"
            ...
            <button
              type="button"
              class="btn btn-primary text-white join-item"
        ...
        input-primary"
                    ...
                    <button
                      type="submit"
                      class="btn btn-primary text-white w-full mt-6"
                      >Añadir</button
                    >
                  </form>
                </form>
